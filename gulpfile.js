...
let path = {
   ...
   src: {
      ...
      js: [
         ...
         sourse_folder + '/js/jquery.js',
         sourse_folder + '/js/transition.js',
         sourse_folder + '/js/aos.js',
         sourse_folder + '/js/CustomEase.min.js',
         sourse_folder + '/js/gsap.min.js',
         sourse_folder + '/js/three.min.js',
         sourse_folder + '/js/panolens.min.js',
