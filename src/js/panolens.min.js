...
$jscomp.initSymbolIterator = function () {
  ...
  d ||
    (d = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol(
      'Symbol.iterator',
    ))
...
$jscomp.initSymbolAsyncIterator = function () {
  ...
  d ||
    (d = $jscomp.global.Symbol.asyncIterator = $jscomp.global.Symbol(
...
$jscomp.asyncExecutePromiseGeneratorProgram = function (d) {
  ...
  ; (function (d, c) {
    ...
    /* this.addEventListener("hoverleave", this.onHoverEnd); */ this.addEventListener(
      ...
      ) /* this.addEventListener("panorama-leave", this.onDismiss); this.addEventListener("dismiss", this.onDismiss); */

      if (window.innerWidth <= 992) {
        this.removeEventListener('dismiss', this.onDismiss)
      }
    ...
    S.prototype = Object.assign(Object.create(c.EventDispatcher.prototype), {
      ...
      addControlBar: function () {
        if (this.container) {
          ...
          b.style.height = '44px'
          b.style.float = 'left'
          b.style.transform = b.style.webkitTransform = b.style.msTransform =
            'translateY(-100%)'
          b.style.background =
          ...
          b.toggle = function () {
            ...
            b.style.transform = b.style.webkitTransform = b.style.msTransform = b.isHidden
              ? 'translateY(0)'
              : 'translateY(-100%)'
            b.style.opacity = a
          }
      ...
      createCustomItem: function (a) {
        ...
        e.style.webkitUserSelect = e.style.MozUserSelect = e.style.userSelect =
          'none'
