...
function testWebP(e){var t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}testWebP((function(e){1==e?document.querySelector("body").classList.add("webp"):document.querySelector("body").classList.add("no-webp")}));const imagesFade=document.querySelectorAll(".image");imagesFade.forEach((e=>{let t=["slide-down","slide-left","slide-right","slide-up"],o=Math.floor(Math.random()*t.length);e.querySelector(".image__item").setAttribute("data-aos",t[o])}));const imagesLarge=document.querySelectorAll(".image-large");imagesLarge.forEach((e=>{let t=["image-large--1","image-large--2","image-large--3","image-large--4","image-large--5","image-large--6","image-large--7"],o=Math.floor(Math.random()*t.length);e.classList.add(t[o])}));const images=document.querySelectorAll(".image");images.forEach((e=>{let t=["mt-100","mt-0"],o=Math.floor(Math.random()*t.length);e.classList.add(t[o]);let a=["image--1","image--2","image--3","image--4","image--5","image--6"],s=Math.floor(Math.random()*a.length);e.classList.add(a[s])})),document.addEventListener("DOMContentLoaded",(function(){if($("body").hasClass("home-page")){function e(){document.querySelectorAll(".logo__wrap").forEach((e=>{e.classList.remove("animate"),setTimeout((function(){e.classList.add("animate")}),200)}))}document.addEventListener("mousemove",(e=>{const t=document.querySelectorAll(".logo");let o=(e.pageX/150).toFixed(1),a=(e.pageY/150).toFixed(1);t.forEach((e=>{e.style.transform=`translate(${o+"px"}, ${a+"px"})`}))})),document.querySelectorAll(".search__btn").forEach((e=>{e.addEventListener("click",(function(){this.closest(".search").classList.toggle("active")}))})),setInterval(e,5e3);const t=document.querySelector(".home__btn-sound");t.addEventListener("click",(function(){t.classList.contains("on")?(t.innerHTML='<span class="home__btn-sound-icon"><img src="img/svg-icons/close.svg" alt=""></span>Ton aus',t.classList.remove("on")):(t.innerHTML='<span class="home__btn-sound-icon"><img src="img/svg-icons/sound-on.svg" alt=""></span>Ton an',t.classList.add("on"))}));new Swiper(".catalog-slider",{navigation:{nextEl:".catalog-slider__btn-next",prevEl:".catalog-slider__btn-prev"},breakpoints:{1100:{slidesPerView:3},768:{},320:{slidesPerView:2}},simulateTouch:!1,allowTouchMove:!1,slidesPerView:3,speed:1e3});document.querySelectorAll(".card").forEach((e=>{var t=e.querySelector(".card__content").clientHeight;e.style.height=t+"px"}))}if($("body").hasClass("page-plug")&&window.innerWidth<992&&($(".plug__table-wrap").attr("data-aos-offset","-500"),$(".plug__table-bg").attr("data-aos-offset","-500")),AOS.init({}),$("body").hasClass("page-plug")){function e(){document.querySelectorAll(".logo__wrap").forEach((e=>{e.classList.remove("animate"),setTimeout((function(){e.classList.add("animate")}),200)}))}$(".plug__btn-to-more").on("click",(function(e){window.innerWidth>=992&&e.preventDefault()})),$(".plug__btn-to-more").on("mouseover",(function(){$(this).find("source").attr("srcset","img/svg-icons/Button_Rollover.svg"),$(this).find("img").attr("src","img/svg-icons/Button_Rollover.svg")})),$(".plug__btn-to-more").on("mouseleave",(function(){$(this).find("source").attr("srcset","img/svg-icons/Button_Idle.svg"),$(this).find("img").attr("src","img/svg-icons/Button_Idle.svg")})),setTimeout((function(){const e=new Swiper(".plug__slider",{simulateTouch:!1,slidesPerView:1,speed:1e3,effect:"creative",creativeEffect:{perspective:!0,limitProgress:1,transformEl:"test"}});var t=!0;setInterval((function(){3!=e.realIndex?0==e.realIndex||1==e.realIndex?1==t?t=!1:0==t&&(e.slideNext(),t=!0):e.slideNext():e.slideTo(0)}),4e3)}),4200),document.addEventListener("mousemove",(e=>{const t=document.querySelector(".plug__logo");let o=(e.pageX/150).toFixed(1),a=(e.pageY/150).toFixed(1);t.style.transform=`translate(${o+"px"}, ${a+"px"})`})),setInterval((()=>{setInterval(e,5e3)}),1e4)}}));
