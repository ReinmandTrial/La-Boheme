...
function testWebP(e){var t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}testWebP((function(e){1==e?document.querySelector("body").classList.add("webp"):document.querySelector("body").classList.add("no-webp")}));const imagesLargeFade=document.querySelectorAll(".image-large");imagesLargeFade.forEach((e=>{let t=["slide-down","slide-left","slide-right","slide-up"],a=Math.floor(Math.random()*t.length);e.querySelector(".image-large__slide").setAttribute("data-aos",t[a])}));const imagesFade=document.querySelectorAll(".image");imagesFade.forEach((e=>{let t=["slide-down","slide-left","slide-right","slide-up"],a=Math.floor(Math.random()*t.length);e.querySelector(".image__item").setAttribute("data-aos",t[a])}));const imagesLarge=document.querySelectorAll(".image-large");imagesLarge.forEach((e=>{let t=["image-large--1","image-large--2","image-large--3","image-large--4","image-large--5","image-large--6","image-large--7"],a=Math.floor(Math.random()*t.length);e.classList.add(t[a])}));const images=document.querySelectorAll(".image");images.forEach((e=>{let t=["mt-100","mt-0"],a=Math.floor(Math.random()*t.length);e.classList.add(t[a]);let o=["image--1","image--2","image--3","image--4","image--5","image--6"],l=Math.floor(Math.random()*o.length);e.classList.add(o[l])})),document.addEventListener("DOMContentLoaded",(function(){document.addEventListener("mousemove",(e=>{const t=document.querySelectorAll(".logo");let a=(e.pageX/150).toFixed(1),o=(e.pageY/150).toFixed(1);t.forEach((e=>{e.style.transform=`translate(${a+"px"}, ${o+"px"})`}))})),document.querySelectorAll(".search__btn").forEach((e=>{e.addEventListener("click",(function(){this.closest(".search").classList.toggle("active")}))})),setInterval((function(){document.querySelector(".logo__wrap").classList.remove("animate"),setTimeout((function(){document.querySelector(".logo__wrap").classList.add("animate")}),200)}),5e3);new Swiper(".catalog-slider",{navigation:{nextEl:".catalog-slider__btn-next",prevEl:".catalog-slider__btn-prev"},breakpoints:{1100:{slidesPerView:3},768:{},320:{slidesPerView:2}},simulateTouch:!1,slidesPerView:3,speed:1e3});AOS.init({once:!1}),document.querySelectorAll(".card").forEach((e=>{var t=e.querySelector(".card__content").clientHeight;e.style.height=t+"px"}))}));
