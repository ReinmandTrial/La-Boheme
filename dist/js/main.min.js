...
function testWebP(e){var t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}testWebP((function(e){1==e?document.querySelector("body").classList.add("webp"):document.querySelector("body").classList.add("no-webp")}));const imagesFade=document.querySelectorAll(".image");imagesFade.forEach((e=>{let t=["slide-down","slide-left","slide-right","slide-up"],a=Math.floor(Math.random()*t.length);e.querySelector(".image__item").setAttribute("data-aos",t[a])}));const imagesLarge=document.querySelectorAll(".image-large");imagesLarge.forEach((e=>{let t=["image-large--1","image-large--2","image-large--3","image-large--4","image-large--5","image-large--6","image-large--7"],a=Math.floor(Math.random()*t.length);e.classList.add(t[a])}));const images=document.querySelectorAll(".image");images.forEach((e=>{let t=["mt-100","mt-0"],a=Math.floor(Math.random()*t.length);e.classList.add(t[a]);let s=["image--1","image--2","image--3","image--4","image--5","image--6"],o=Math.floor(Math.random()*s.length);e.classList.add(s[o])})),document.addEventListener("DOMContentLoaded",(function(){if($("body").hasClass("home-page")){function e(){document.querySelectorAll(".logo__wrap").forEach((e=>{e.classList.remove("animate"),setTimeout((function(){e.classList.add("animate")}),200)}))}document.addEventListener("mousemove",(e=>{const t=document.querySelectorAll(".logo");let a=(e.pageX/150).toFixed(1),s=(e.pageY/150).toFixed(1);t.forEach((e=>{e.style.transform=`translate(${a+"px"}, ${s+"px"})`}))})),document.querySelectorAll(".search__btn").forEach((e=>{e.addEventListener("click",(function(){this.closest(".search").classList.toggle("active")}))})),setInterval(e,5e3);const t=document.querySelector(".home__btn-sound");t.addEventListener("click",(function(){t.classList.contains("on")?(t.innerHTML='<span class="home__btn-sound-icon"><img src="img/svg-icons/close.svg" alt=""></span>Ton aus',t.classList.remove("on")):(t.innerHTML='<span class="home__btn-sound-icon"><img src="img/svg-icons/sound-on.svg" alt=""></span>Ton an',t.classList.add("on"))}));new Swiper(".catalog-slider",{navigation:{nextEl:".catalog-slider__btn-next",prevEl:".catalog-slider__btn-prev"},breakpoints:{1100:{slidesPerView:3},768:{},320:{slidesPerView:2}},simulateTouch:!1,allowTouchMove:!1,slidesPerView:3,speed:1e3});document.querySelectorAll(".card").forEach((e=>{var t=e.querySelector(".card__content").clientHeight;e.style.height=t+"px"}))}if($("body").hasClass("page-plug")&&window.innerWidth<992&&($(".plug__table-wrap").attr("data-aos-offset","-500"),$(".plug__table-bg").attr("data-aos-offset","-500")),AOS.init({}),$("body").hasClass("page-plug")){function e(){document.querySelectorAll(".logo__wrap").forEach((e=>{e.classList.remove("animate"),setTimeout((function(){e.classList.add("animate")}),200)}))}$(".plug__btn-to-more").on("mouseover",(function(){$(this).find("source").attr("srcset","img/svg-icons/Button_Rollover.svg"),$(this).find("img").attr("src","img/svg-icons/Button_Rollover.svg")})),$(".plug__btn-to-more").on("mouseleave",(function(){$(this).find("source").attr("srcset","img/svg-icons/Button_Idle.svg"),$(this).find("img").attr("src","img/svg-icons/Button_Idle.svg")})),setTimeout((function(){const e=new Swiper(".plug__slider",{simulateTouch:!1,slidesPerView:1,speed:1e3,effect:"creative",creativeEffect:{perspective:!0,limitProgress:1,transformEl:"test"}});var t=!0;setInterval((function(){3!=e.realIndex?0==e.realIndex||1==e.realIndex?1==t?t=!1:0==t&&(e.slideNext(),t=!0):e.slideNext():e.slideTo(0)}),4e3)}),4200),document.addEventListener("mousemove",(e=>{const t=document.querySelector(".plug__logo");let a=(e.pageX/150).toFixed(1),s=(e.pageY/150).toFixed(1);t.style.transform=`translate(${a+"px"}, ${s+"px"})`})),setInterval((()=>{setInterval(e,5e3)}),1e4);let t=gsap.from(".plug__table-wrap",{y:-1*window.innerHeight,ease:"power2.out",duration:3,delay:2}),a=gsap.from(".plug__table-bg",{y:-1*window.innerHeight,ease:"power2.out",duration:3,delay:2}),s=gsap.from(".plug__main-image-wrap",{ease:CustomEase.create("custom","M0,0 C0.382,0.896 0.426,0.986 0.562,1.03 0.664,1.063 0.76,1.092 1,1 "),width:0,duration:1,delay:.6});$(".pt-trigger").on("click",(function(){$(this).hasClass("plug__logo")||$(this).hasClass("plug__text-logo")||$(this).hasClass("plug__btn-to-more")||setTimeout((()=>{$(".pt-page-1").hasClass("pt-page-current")&&(console.log("restart"),t.restart(!0,!1),a.restart(!0,!1),s.restart(!0,!1))}),100)}))}}));
window.Modernizr=function(e,t,a){function o(e){f.cssText=e}function n(e,t){return typeof e===t}function p(e,t){return!!~(""+e).indexOf(t)}function r(e,t){for(var o in e){var n=e[o];if(!p(n,"-")&&f[n]!==a)return"pfx"!=t||n}return!1}function i(e,t,o){for(var p in e){var r=t[e[p]];if(r!==a)return!1===o?e[p]:n(r,"function")?r.bind(o||t):r}return!1}function s(e,t,a){var o=e.charAt(0).toUpperCase()+e.slice(1),p=(e+" "+b.join(o+" ")+o).split(" ");return n(t,"string")||n(t,"undefined")?r(p,t):i(p=(e+" "+y.join(o+" ")+o).split(" "),t,a)}var c,l,g={},u=t.documentElement,d="modernizr",m=t.createElement(d),f=m.style,h=" -webkit- -moz- -o- -ms- ".split(" "),v="Webkit Moz O ms",b=v.split(" "),y=v.toLowerCase().split(" "),k={},F=[],T=F.slice,C=function(e,a,o,n){var p,r,i,s,c=t.createElement("div"),l=t.body,g=l||t.createElement("body");if(parseInt(o,10))for(;o--;)(i=t.createElement("div")).id=n?n[o]:d+(o+1),c.appendChild(i);return p=["&#173;",'<style id="s',d,'">',e,"</style>"].join(""),c.id=d,(l?c:g).innerHTML+=p,g.appendChild(c),l||(g.style.background="",g.style.overflow="hidden",s=u.style.overflow,u.style.overflow="hidden",u.appendChild(g)),r=a(c,e),l?c.parentNode.removeChild(c):(g.parentNode.removeChild(g),u.style.overflow=s),!!r},E={}.hasOwnProperty;for(var L in l=n(E,"undefined")||n(E.call,"undefined")?function(e,t){return t in e&&n(e.constructor.prototype[t],"undefined")}:function(e,t){return E.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(e){var t=this;if("function"!=typeof t)throw new TypeError;var a=T.call(arguments,1),o=function(){if(this instanceof o){var n=function(){};n.prototype=t.prototype;var p=new n,r=t.apply(p,a.concat(T.call(arguments)));return Object(r)===r?r:p}return t.apply(e,a.concat(T.call(arguments)))};return o}),k.touch=function(){var a;return"ontouchstart"in e||e.DocumentTouch&&t instanceof DocumentTouch?a=!0:C(["@media (",h.join("touch-enabled),("),d,")","{#modernizr{top:9px;position:absolute}}"].join(""),(function(e){a=9===e.offsetTop})),a},k.cssanimations=function(){return s("animationName")},k.csstransitions=function(){return s("transition")},k)l(k,L)&&(c=L.toLowerCase(),g[c]=k[L](),F.push((g[c]?"":"no-")+c));return g.addTest=function(e,t){if("object"==typeof e)for(var o in e)l(e,o)&&g.addTest(o,e[o]);else{if(e=e.toLowerCase(),g[e]!==a)return g;t="function"==typeof t?t():t,u.className+=" "+(t?"":"no-")+e,g[e]=t}return g},o(""),m=null,function(e,t){function a(){var e=m.elements;return"string"==typeof e?e.split(" "):e}function o(e){var t=d[e[g]];return t||(t={},u++,e[g]=u,d[u]=t),t}function n(e,a,n){return a||(a=t),i?a.createElement(e):(n||(n=o(a)),(p=n.cache[e]?n.cache[e].cloneNode():l.test(e)?(n.cache[e]=n.createElem(e)).cloneNode():n.createElem(e)).canHaveChildren&&!c.test(e)?n.frag.appendChild(p):p);var p}function p(e){e||(e=t);var p=o(e);return m.shivCSS&&!r&&!p.hasCSS&&(p.hasCSS=!!function(e,t){var a=e.createElement("p"),o=e.getElementsByTagName("head")[0]||e.documentElement;return a.innerHTML="x<style>"+t+"</style>",o.insertBefore(a.lastChild,o.firstChild)}(e,"article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:pageWrapper}mark{background:#FF0;color:#000}")),i||function(e,t){t.cache||(t.cache={},t.createElem=e.createElement,t.createFrag=e.createDocumentFragment,t.frag=t.createFrag()),e.createElement=function(a){return m.shivMethods?n(a,e,t):t.createElem(a)},e.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+a().join().replace(/\w+/g,(function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'}))+");return n}")(m,t.frag)}(e,p),e}var r,i,s=e.html5||{},c=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,l=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,g="_html5shiv",u=0,d={};!function(){try{var e=t.createElement("a");e.innerHTML="<xyz></xyz>",r="hidden"in e,i=1==e.childNodes.length||function(){t.createElement("a");var e=t.createDocumentFragment();return void 0===e.cloneNode||void 0===e.createDocumentFragment||void 0===e.createElement}()}catch(e){r=!0,i=!0}}();var m={elements:s.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",shivCSS:!1!==s.shivCSS,supportsUnknownElements:i,shivMethods:!1!==s.shivMethods,type:"default",shivDocument:p,createElement:n,createDocumentFragment:function(e,n){if(e||(e=t),i)return e.createDocumentFragment();for(var p=(n=n||o(e)).frag.cloneNode(),r=0,s=a(),c=s.length;r<c;r++)p.createElement(s[r]);return p}};e.html5=m,p(t)}(this,t),g._version="2.6.2",g._prefixes=h,g._domPrefixes=y,g._cssomPrefixes=b,g.testProp=function(e){return r([e])},g.testAllProps=s,g.testStyles=C,g.prefixed=function(e,t,a){return t?s(e,t,a):s(e,"pfx")},u.className=u.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+" js "+F.join(" "),g}(this,this.document),function(e,t,a){function o(e){return"[object Function]"==h.call(e)}function n(e){return"string"==typeof e}function p(){}function r(e){return!e||"loaded"==e||"complete"==e||"uninitialized"==e}function i(){var e=v.shift();b=1,e?e.t?m((function(){("c"==e.t?u.injectCss:u.injectJs)(e.s,0,e.a,e.x,e.e,1)}),0):(e(),i()):b=0}function s(e,a,o,n,p,s,c){function l(t){if(!d&&r(g.readyState)&&(y.r=d=1,!b&&i(),g.onload=g.onreadystatechange=null,t))for(var o in"img"!=e&&m((function(){F.removeChild(g)}),50),w[a])w[a].hasOwnProperty(o)&&w[a][o].onload()}c=c||u.errorTimeout;var g=t.createElement(e),d=0,h=0,y={t:o,s:a,e:p,a:s,x:c};1===w[a]&&(h=1,w[a]=[]),"object"==e?g.data=a:(g.src=a,g.type=e),g.width=g.height="0",g.onerror=g.onload=g.onreadystatechange=function(){l.call(this,h)},v.splice(n,0,y),"img"!=e&&(h||2===w[a]?(F.insertBefore(g,k?null:f),m(l,c)):w[a].push(g))}function c(e,t,a,o,p){return b=0,t=t||"j",n(e)?s("c"==t?C:T,e,t,this.i++,a,o,p):(v.splice(this.i++,0,e),1==v.length&&i()),this}function l(){var e=u;return e.loader={load:c,i:0},e}var g,u,d=t.documentElement,m=e.setTimeout,f=t.getElementsByTagName("script")[0],h={}.toString,v=[],b=0,y="MozAppearance"in d.style,k=y&&!!t.createRange().compareNode,F=k?d:f.parentNode,T=(d=e.opera&&"[object Opera]"==h.call(e.opera),d=!!t.attachEvent&&!d,y?"object":d?"script":"img"),C=d?"script":T,E=Array.isArray||function(e){return"[object Array]"==h.call(e)},L=[],w={},R={timeout:function(e,t){return t.length&&(e.timeout=t[0]),e}};u=function(e){function t(e,t,a,n,p){var r=function(e){e=e.split("!");var t,a,o,n=L.length,p=e.pop(),r=e.length;for(p={url:p,origUrl:p,prefixes:e},a=0;a<r;a++)o=e[a].split("="),(t=R[o.shift()])&&(p=t(p,o));for(a=0;a<n;a++)p=L[a](p);return p}(e),i=r.autoCallback;r.url.split(".").pop().split("?").shift(),r.bypass||(t&&(t=o(t)?t:t[e]||t[n]||t[e.split("/").pop().split("?")[0]]),r.instead?r.instead(e,t,a,n,p):(w[r.url]?r.noexec=!0:w[r.url]=1,a.load(r.url,r.forceCSS||!r.forceJS&&"css"==r.url.split(".").pop().split("?").shift()?"c":undefined,r.noexec,r.attrs,r.timeout),(o(t)||o(i))&&a.load((function(){l(),t&&t(r.origUrl,p,n),i&&i(r.origUrl,p,n),w[r.url]=2}))))}function a(e,a){function r(e,p){if(e){if(n(e))p||(g=function(){var e=[].slice.call(arguments);u.apply(this,e),d()}),t(e,g,a,0,c);else if(Object(e)===e)for(s in i=function(){var t,a=0;for(t in e)e.hasOwnProperty(t)&&a++;return a}(),e)e.hasOwnProperty(s)&&(!p&&!--i&&(o(g)?g=function(){var e=[].slice.call(arguments);u.apply(this,e),d()}:g[s]=function(e){return function(){var t=[].slice.call(arguments);e&&e.apply(this,t),d()}}(u[s])),t(e[s],g,a,s,c))}else!p&&d()}var i,s,c=!!e.test,l=e.load||e.both,g=e.callback||p,u=g,d=e.complete||p;r(c?e.yep:e.nope,!!l),l&&r(l)}var r,i,s=this.yepnope.loader;if(n(e))t(e,0,s,0);else if(E(e))for(r=0;r<e.length;r++)n(i=e[r])?t(i,0,s,0):E(i)?u(i):Object(i)===i&&a(i,s);else Object(e)===e&&a(e,s)},u.addPrefix=function(e,t){R[e]=t},u.addFilter=function(e){L.push(e)},u.errorTimeout=1e4,null==t.readyState&&t.addEventListener&&(t.readyState="loading",t.addEventListener("DOMContentLoaded",g=function(){t.removeEventListener("DOMContentLoaded",g,0),t.readyState="complete"},0)),e.yepnope=l(),e.yepnope.executeStack=i,e.yepnope.injectJs=function(e,a,o,n,s,c){var l,g,d=t.createElement("script");n=n||u.errorTimeout;for(g in d.src=e,o)d.setAttribute(g,o[g]);a=c?i:a||p,d.onreadystatechange=d.onload=function(){!l&&r(d.readyState)&&(l=1,a(),d.onload=d.onreadystatechange=null)},m((function(){l||(l=1,a(1))}),n),s?d.onload():f.parentNode.insertBefore(d,f)},e.yepnope.injectCss=function(e,a,o,n,r,s){var c;n=t.createElement("link"),a=s?i:a||p;for(c in n.href=e,n.rel="stylesheet",n.type="text/css",o)n.setAttribute(c,o[c]);r||(f.parentNode.insertBefore(n,f),m(a,0))}}(this,document),Modernizr.load=function(){yepnope.apply(window,[].slice.call(arguments,0))};var PageTransitions=function(){var e={WebkitAnimation:"webkitAnimationEnd",OAnimation:"oAnimationEnd",msAnimation:"MSAnimationEnd",animation:"animationend"}[Modernizr.prefixed("animation")],t=Modernizr.cssanimations;function a(e,t,a){!function(e,t){t.attr("class",t.data("originalClassList")),e.attr("class",e.data("originalClassList")+" pt-page-current")}(t,a),e.data("isAnimating",!1)}return{init:function(){$(".pt-page").each((function(){var e=$(this);e.data("originalClassList",e.attr("class"))})),$(".pt-wrapper").each((function(){var e=$(this);e.data("current",0),e.data("isAnimating",!1),e.children(".pt-page").eq(0).addClass("pt-page-current")})),$(".pt-trigger").on("click",(function(){$pageTrigger=$(this),function(o){if(!o.attr("data-animation"))return alert("Transition.js : Invalid attribute configuration. \n\n 'data-animation' attribute not found"),!1;if(!o.attr("data-goto"))return alert("Transition.js : Invalid attribute configuration. \n\n 'data-goto' attribute not found"),!1;var n,p,r,i,s=o.data("animation").toString();if(-1!=s.indexOf("-")){var c=s.split("-");i=parseInt(c[Math.floor(Math.random()*c.length)])}else i=parseInt(s);if(i>67)return alert("Transition.js : Invalid 'data-animation' attribute configuration. Animation number should not be greater than 67"),!1;switch(i){case 1:p="pt-page-moveFromRight",r="pt-page-moveToLeft";break;case 2:p="pt-page-moveFromLeft",r="pt-page-moveToRight";break;case 3:p="pt-page-moveFromBottom",r="pt-page-moveToTop";break;case 4:p="pt-page-moveFromTop",r="pt-page-moveToBottom";break;case 5:p="pt-page-moveFromRight pt-page-ontop",r="pt-page-fade";break;case 6:p="pt-page-moveFromLeft pt-page-ontop",r="pt-page-fade";break;case 7:p="pt-page-moveFromBottom pt-page-ontop",r="pt-page-fade";break;case 8:p="pt-page-moveFromTop pt-page-ontop",r="pt-page-fade";break;case 9:p="pt-page-moveFromRightFade",r="pt-page-moveToLeftFade";break;case 10:p="pt-page-moveFromLeftFade",r="pt-page-moveToRightFade";break;case 11:p="pt-page-moveFromBottomFade",r="pt-page-moveToTopFade";break;case 12:p="pt-page-moveFromTopFade",r="pt-page-moveToBottomFade";break;case 13:p="pt-page-moveFromRight",r="pt-page-moveToLeftEasing pt-page-ontop";break;case 14:p="pt-page-moveFromLeft",r="pt-page-moveToRightEasing pt-page-ontop";break;case 15:p="pt-page-moveFromBottom",r="pt-page-moveToTopEasing pt-page-ontop";break;case 16:p="pt-page-moveFromTop",r="pt-page-moveToBottomEasing pt-page-ontop";break;case 17:p="pt-page-moveFromRight pt-page-ontop",r="pt-page-scaleDown";break;case 18:p="pt-page-moveFromLeft pt-page-ontop",r="pt-page-scaleDown";break;case 19:p="pt-page-moveFromBottom pt-page-ontop",r="pt-page-scaleDown";break;case 20:p="pt-page-moveFromTop pt-page-ontop",r="pt-page-scaleDown";break;case 21:p="pt-page-scaleUpDown pt-page-delay300",r="pt-page-scaleDown";break;case 22:p="pt-page-scaleUp pt-page-delay300",r="pt-page-scaleDownUp";break;case 23:p="pt-page-scaleUp",r="pt-page-moveToLeft pt-page-ontop";break;case 24:p="pt-page-scaleUp",r="pt-page-moveToRight pt-page-ontop";break;case 25:p="pt-page-scaleUp",r="pt-page-moveToTop pt-page-ontop";break;case 26:p="pt-page-scaleUp",r="pt-page-moveToBottom pt-page-ontop";break;case 27:p="pt-page-scaleUpCenter pt-page-delay400",r="pt-page-scaleDownCenter";break;case 28:p="pt-page-moveFromRight pt-page-delay200 pt-page-ontop",r="pt-page-rotateRightSideFirst";break;case 29:p="pt-page-moveFromLeft pt-page-delay200 pt-page-ontop",r="pt-page-rotateLeftSideFirst";break;case 30:p="pt-page-moveFromTop pt-page-delay200 pt-page-ontop",r="pt-page-rotateTopSideFirst";break;case 31:p="pt-page-moveFromBottom pt-page-delay200 pt-page-ontop",r="pt-page-rotateBottomSideFirst";break;case 32:p="pt-page-flipInLeft pt-page-delay500",r="pt-page-flipOutRight";break;case 33:p="pt-page-flipInRight pt-page-delay500",r="pt-page-flipOutLeft";break;case 34:p="pt-page-flipInBottom pt-page-delay500",r="pt-page-flipOutTop";break;case 35:p="pt-page-flipInTop pt-page-delay500",r="pt-page-flipOutBottom";break;case 36:p="pt-page-scaleUp",r="pt-page-rotateFall pt-page-ontop";break;case 37:p="pt-page-rotateInNewspaper pt-page-delay500",r="pt-page-rotateOutNewspaper";break;case 38:p="pt-page-moveFromRight",r="pt-page-rotatePushLeft";break;case 39:p="pt-page-moveFromLeft",r="pt-page-rotatePushRight";break;case 40:p="pt-page-moveFromBottom",r="pt-page-rotatePushTop";break;case 41:p="pt-page-moveFromTop",r="pt-page-rotatePushBottom";break;case 42:p="pt-page-rotatePullRight pt-page-delay180",r="pt-page-rotatePushLeft";break;case 43:p="pt-page-rotatePullLeft pt-page-delay180",r="pt-page-rotatePushRight";break;case 44:p="pt-page-rotatePullBottom pt-page-delay180",r="pt-page-rotatePushTop";break;case 45:p="pt-page-rotatePullTop pt-page-delay180",r="pt-page-rotatePushBottom";break;case 46:p="pt-page-moveFromRightFade",r="pt-page-rotateFoldLeft";break;case 47:p="pt-page-moveFromLeftFade",r="pt-page-rotateFoldRight";break;case 48:p="pt-page-moveFromBottomFade",r="pt-page-rotateFoldTop";break;case 49:p="pt-page-moveFromTopFade",r="pt-page-rotateFoldBottom";break;case 50:p="pt-page-rotateUnfoldLeft",r="pt-page-moveToRightFade";break;case 51:p="pt-page-rotateUnfoldRight",r="pt-page-moveToLeftFade";break;case 52:p="pt-page-rotateUnfoldTop",r="pt-page-moveToBottomFade";break;case 53:p="pt-page-rotateUnfoldBottom",r="pt-page-moveToTopFade";break;case 54:p="pt-page-rotateRoomLeftIn",r="pt-page-rotateRoomLeftOut pt-page-ontop";break;case 55:p="pt-page-rotateRoomRightIn",r="pt-page-rotateRoomRightOut pt-page-ontop";break;case 56:p="pt-page-rotateRoomTopIn",r="pt-page-rotateRoomTopOut pt-page-ontop";break;case 57:p="pt-page-rotateRoomBottomIn",r="pt-page-rotateRoomBottomOut pt-page-ontop";break;case 58:p="pt-page-rotateCubeLeftIn",r="pt-page-rotateCubeLeftOut pt-page-ontop";break;case 59:p="pt-page-rotateCubeRightIn",r="pt-page-rotateCubeRightOut pt-page-ontop";break;case 60:p="pt-page-rotateCubeTopIn",r="pt-page-rotateCubeTopOut pt-page-ontop";break;case 61:p="pt-page-rotateCubeBottomIn",r="pt-page-rotateCubeBottomOut pt-page-ontop";break;case 62:p="pt-page-rotateCarouselLeftIn",r="pt-page-rotateCarouselLeftOut pt-page-ontop";break;case 63:p="pt-page-rotateCarouselRightIn",r="pt-page-rotateCarouselRightOut pt-page-ontop";break;case 64:p="pt-page-rotateCarouselTopIn",r="pt-page-rotateCarouselTopOut pt-page-ontop";break;case 65:p="pt-page-rotateCarouselBottomIn",r="pt-page-rotateCarouselBottomOut pt-page-ontop";break;case 66:p="pt-page-rotateSidesIn pt-page-delay200",r="pt-page-rotateSidesOut";break;case 67:p="pt-page-rotateSlideIn",r="pt-page-rotateSlideOut"}var l,g=o.closest(".pt-wrapper"),u=g.data("current"),d=g.children("div.pt-page"),m=d.length,f=!1,h=!1;if(n=parseInt(o.data("goto")),m<n)alert("Transition.js : Invalid 'data-goto' attribute configuration.");else{if(l=u,g.data("isAnimating"))return!1;g.data("isAnimating",!0);var v=d.eq(u);if(-1==n?u<m-1?++u:u=0:-2==n?0==u?u=m-1:u<=m-1?--u:u=0:u=n-1,l!=u){g.data("current",u);var b=d.eq(u).addClass("pt-page-current");v.addClass(r).on(e,(function(){v.off(e),f=!0,h&&a(g,b,v)})),b.addClass(p).on(e,(function(){b.off(e),h=!0,f&&a(g,b,v)}))}else g.data("isAnimating",!1)}t||a(v,b)}($pageTrigger),setTimeout((function(){AOS.refreshHard()}),650)}))}}}();$(document).ready((function(){PageTransitions.init()}));