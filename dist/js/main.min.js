...
function testWebP(e){var t=new Image;t.onload=t.onerror=function(){e(2==t.height)},t.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"}testWebP((function(e){1==e?document.querySelector("body").classList.add("webp"):document.querySelector("body").classList.add("no-webp")}));const imagesFade=document.querySelectorAll(".image");imagesFade.forEach((e=>{let t=["slide-down","slide-left","slide-right","slide-up"],a=Math.floor(Math.random()*t.length);e.querySelector(".image__item").setAttribute("data-aos",t[a])}));const imagesLarge=document.querySelectorAll(".image-large");imagesLarge.forEach((e=>{let t=["image-large--1","image-large--2","image-large--3","image-large--4","image-large--5","image-large--6","image-large--7"],a=Math.floor(Math.random()*t.length);e.classList.add(t[a])}));const images=document.querySelectorAll(".image");images.forEach((e=>{let t=["mt-100","mt-0"],a=Math.floor(Math.random()*t.length);e.classList.add(t[a]);let o=["image--1","image--2","image--3","image--4","image--5","image--6"],s=Math.floor(Math.random()*o.length);e.classList.add(o[s])})),document.addEventListener("DOMContentLoaded",(function(){if($("body").hasClass("home-page")){document.addEventListener("mousemove",(e=>{const t=document.querySelectorAll(".logo");let a=(e.pageX/150).toFixed(1),o=(e.pageY/150).toFixed(1);t.forEach((e=>{e.style.transform=`translate(${a+"px"}, ${o+"px"})`}))})),document.querySelectorAll(".search__btn").forEach((e=>{e.addEventListener("click",(function(){this.closest(".search").classList.toggle("active")}))})),setInterval((function(){document.querySelector(".logo__wrap").classList.remove("animate"),setTimeout((function(){document.querySelector(".logo__wrap").classList.add("animate")}),200)}),5e3);const e=document.querySelector(".home__btn-sound");e.addEventListener("click",(function(){e.classList.contains("on")?(e.innerHTML='<span class="home__btn-sound-icon"><img src="img/svg-icons/close.svg" alt=""></span>Ton aus',e.classList.remove("on")):(e.innerHTML='<span class="home__btn-sound-icon"><img src="img/svg-icons/sound-on.svg" alt=""></span>Ton an',e.classList.add("on"))}));new Swiper(".catalog-slider",{navigation:{nextEl:".catalog-slider__btn-next",prevEl:".catalog-slider__btn-prev"},breakpoints:{1100:{slidesPerView:3},768:{},320:{slidesPerView:2}},simulateTouch:!1,slidesPerView:3,speed:1e3});document.querySelectorAll(".card").forEach((e=>{var t=e.querySelector(".card__content").clientHeight;e.style.height=t+"px"}))}AOS.init({once:!1}),$("body").hasClass("page-plug")&&setTimeout((function(){const e=new Swiper(".plug__slider",{simulateTouch:!1,slidesPerView:1,speed:1e3,effect:"creative",creativeEffect:{perspective:!0,limitProgress:1,transformEl:"test"}});var t=!0;setInterval((function(){3!=e.realIndex?0==e.realIndex||1==e.realIndex?1==t?t=!1:0==t&&(e.slideNext(),t=!0):e.slideNext():e.slideTo(0),console.log(e.realIndex),console.log("next")}),4e3)}),4200)}));
